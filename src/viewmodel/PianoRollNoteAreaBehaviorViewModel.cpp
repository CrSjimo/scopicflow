...
namespace sflow {
    ...
    SFLOW_VIEWMODEL_IMPLEMENT_PROPERTY(PianoRollNoteAreaBehaviorViewModel, editing, editing, setEditing, resetEditing)
    SFLOW_VIEWMODEL_IMPLEMENT_PROPERTY(PianoRollNoteAreaBehaviorViewModel, unitedExtend, unitedExtend, setUnitedExtend, resetUnitedExtend)
    SFLOW_VIEWMODEL_IMPLEMENT_PROPERTY(PianoRollNoteAreaBehaviorViewModel, color, color, setColor, resetColor)
    SFLOW_VIEWMODEL_IMPLEMENT_PROPERTY(PianoRollNoteAreaBehaviorViewModel, compactDisplay, compactDisplay, setCompactDisplay, resetCompactDisplay)
