...
#ifndef SCOPIC_FLOW_CORE_EXPORT
#  ifdef SCOPICFLOWCORE_STATIC
#    define SCOPIC_FLOW_CORE_EXPORT
#  else
#    ifdef SCOPICFLOWCORE_LIBRARY
#      define SCOPIC_FLOW_CORE_EXPORT Q_DECL_EXPORT
#    else
#      define SCOPIC_FLOW_CORE_EXPORT Q_DECL_IMPORT
#    endif
#  endif
#endif
