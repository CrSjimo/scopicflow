...
namespace sflow {
    ...
    SFLOW_VIEWMODEL_IMPLEMENT_PROPERTY(BusTrackViewModel, mute, mute, setMute, resetMute)
    SFLOW_VIEWMODEL_IMPLEMENT_PROPERTY(BusTrackViewModel, route, route, setRoute, resetRoute)
    ...
    SFLOW_VIEWMODEL_IMPLEMENT_PROPERTY(BusTrackViewModel, intermediate, intermediate, setIntermediate, resetIntermediate)
    ...
    SFLOW_VIEWMODEL_IMPLEMENT_PROPERTY(BusTrackViewModel, selected, selected, setSelected, resetSelected)
